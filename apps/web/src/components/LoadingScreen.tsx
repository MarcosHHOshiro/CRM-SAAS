...
export function LoadingScreen({
  ...
  return (
    <div className="flex min-h-[40vh] items-center justify-center px-6 py-12">
      <div className="flex w-full max-w-md flex-col items-center rounded-[2rem] border border-[var(--border)] bg-[var(--card)] px-8 py-10 text-center shadow-[var(--shadow-soft)] backdrop-blur">
