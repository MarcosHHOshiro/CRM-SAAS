  ...
  return (
    <section className="rounded-[2rem] border border-[var(--border)] bg-[var(--card)] p-6 shadow-[var(--shadow-soft)]">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div>
          <p className="text-sm font-semibold uppercase tracking-[0.2em] text-[var(--accent)]">Lead filters</p>
          <h2 className="mt-3 text-2xl font-semibold text-[var(--foreground)]">Pipeline lead list</h2>
          <p className="mt-2 text-sm leading-6 text-[var(--foreground-muted)]">
            Search and filter leads from the current organization, then create, update, convert, or remove them.
          </p>
        </div>
        <Link
